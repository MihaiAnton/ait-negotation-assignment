...
public class SimpleLinearOrdering implements UtilitySpace {
	...
	/**
	 * List of bids. worst bid first, best bid last.
	 */
	...
	/**
	 * @param bid       a new {@link Bid} to be inserted
	 * @param worseBids all bids that are worse than this bid.
	 * @return a {@link SimpleLinearOrdering}, updated with the given
	 *         comparison. Thee bid will be inserted after the first bid that is
	 *         not worse than bid.
	 */
